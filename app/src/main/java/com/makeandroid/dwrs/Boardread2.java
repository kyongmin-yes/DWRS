...
import com.makeandroid.dwrs.adapters.Post2commentadapter;
...
public class Boardread2 extends AppCompatActivity implements RecyclerViewitemclickListener.OnItemClickListener {
    ...
    private Post2commentadapter madapter;
    private List<Comments2> mdatas;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_boardread2);

        mTitleText = findViewById(R.id.boardread2_title);
        mContentsText = findViewById(R.id.boardread2_contents);
        mNameText = findViewById(R.id.boardread2_nickname);

        mCommentsRecyclerView = findViewById(R.id.boardread2_recyclerView);
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            if (task.getResult().exists()) {
                                ...
                                Toast.makeText(Boardread2.this, "삭제된 글입니다.", Toast.LENGTH_SHORT).show();
                            }
                        }
                    }
                });
    ...
    protected void onStart() {//리사이클러 안에 값 넣어주는 함수
        ...
        mStore.collection(UserAccount.Breakdowncomments)//저장소에서 포스트에 해당하는 데이터 불러오기
                .get()//가져오기
                        ...
                        if (task.isSuccessful()) {//성공시
                            if (task.getResult() != null) {//결과값이 null이 아니면
                                ...
                                for (DocumentSnapshot snapshot : task.getResult()) {//모두 불러오려면 for문 써야함
                                    ...
                                    Comments2 data = new Comments2(uid, nickname, comments); //post클래스의 생성자에서 들어감 -> 객체 생성
                                    mdatas.add(data);//리스트에 저장


                                }

                                madapter = new Post2commentadapter(mdatas);//어댑터에 리스트 저장
    ...
    public void onItemLongClick(View view, int position) {
        ...
        dialog.setPositiveButton("삭제", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(Boardread2.this, "취소 되었습니다.", Toast.LENGTH_SHORT).show();
            }
        });
