...
public class Boardwrite extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mtitle = findViewById(R.id.boardwrite_title);
        mcontents = findViewById(R.id.boardwrite_contents);

        findViewById(R.id.boardwrite_btn).setOnClickListener(this);
    ...
    public void onClick(View v){
        if(mAuth.getCurrentUser() != null){
            ...
            mStore.collection(UserAccount.post).document(postid).set(data, SetOptions.merge());
            finish();
        }
    }
}